...
def main(appid, api_secret, api_key, gpt_url, domain, query):
    ...
    ws = websocket.WebSocketApp(wsUrl, on_message=on_message,on_close=on_close,on_open=on_open)
    ws.appid = appid
    ws.query = query
    ws.domain = domain
...
if __name__ == "__main__":
    main(
        appid="ee3d6c08",
        api_secret="ZDU3NjM3M2ViNmRhNTBlYzY5OTllMjNm",
        api_key="0d565464aaac90e2c7b0e6d3bd927039",
