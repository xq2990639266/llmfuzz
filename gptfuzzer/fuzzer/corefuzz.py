    ...
    def evaluate(self):
        ...
        for question in self.questions:
            ...
            #对回答的预测 
                ...
                # if(self.state == "local"):
                #     from gptfuzzer.utils.local_judge import judgement
                #     result = judgement(response)
                # else:
                #     from gptfuzzer.utils.oneapi_judge import judge
                #     result = judge(self.oneApi_address_judge,self.apikey_judge,self.channelId_judge,self.model_name_judge,response)
